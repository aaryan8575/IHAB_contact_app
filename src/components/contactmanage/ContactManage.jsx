    ...
    <div classname={styles.main}>
      ...
      <div className={styles.bodycontent}>
        <div className={styles.bodyheader}>
          ...
          <div className={styles.export}><p className={styles.exportpara}>Sync contacts</p></div>
          </div>
        </div>

        <div className={styles.paragraph}>
          <div className={styles.para}><p className={styles.tex}>connect with google</p></div>
          <div className={styles.button}>
            <div className={styles.icon}></div>
            <div className={styles.iconcontent}><p className={styles.connect}>Connect</p></div>
          </div>
        </div>

        <div className={styles.paragraph}>
          <div className={styles.para}><p className={styles.tex}>Connect with HubSpot</p></div>
          <div className={styles.button}>
            <div className={styles.icon}></div>
            <div className={styles.iconcontent}><p className={styles.connect}>Connect</p></div>
          </div>
        ...
        <div className={styles.paragraph}>
          <div className={styles.para}><p className={styles.tex}>Connect with salesforce</p></div>
          <div className={styles.button}>
            <div className={styles.icon}></div>
            <div className={styles.iconcontent}><p className={styles.connect}>Connect</p></div>
          </div>
